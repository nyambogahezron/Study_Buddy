...
from .forms import RoomForm, UserForm, UserCreationForm_Customized
...
def createRoom(request):
    ...
    form_Title = 'Create'
    context = {'form': form, 'topics': topics, 'formTitle': form_Title}
...
def updateRoom(request, pk):
    ...
    context = {'form': form, "room": room, "topics": topics, "formTitle": form_Title}   
    return render(request, 'base/room_form.html', context)
